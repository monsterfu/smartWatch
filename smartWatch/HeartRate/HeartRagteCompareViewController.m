//
//  HeartRagteCompareViewController.m
//  smartWatch
//
...
#import "HeartRagteCompareViewController.h"

@interface HeartRagteCompareViewController ()

@end

@implementation HeartRagteCompareViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    _greenColorView.layer.cornerRadius = _greenColorView.frame.size.width/2;
    _greenColorView.layer.masksToBounds = YES;
    _redColorView.layer.cornerRadius = _redColorView.frame.size.width/2;
    _redColorView.layer.masksToBounds = YES;
